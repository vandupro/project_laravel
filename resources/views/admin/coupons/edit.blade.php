        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-center">
                    <form id="couponForm" action="{{route('admin.coupons.update')}}" method="post" role="form">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$coupon->quantity}}" tyluowngjnumber min="1" name="quantity" class="form-control" "
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="type" id="">
                                <option @if($coupon->type==1) 'selected' @endif value="1">Phần trăm</option>
                                <option @if($coupon->type==2) 'selected' @endif value="2">Tiền</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="">Số tiền hoặc % giảm</label>
                            <input value="{{$coupon->discount}}" tyluowngjnumber min="1" name="discount" class="form-control" "
